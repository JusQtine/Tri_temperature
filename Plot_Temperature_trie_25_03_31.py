...
plt.figure()
plt.plot(time_device1[:300], tab_trie_device1[:300],'.', label='Device 1', color='blue')
...
plt.plot(time_device1_seconds/5, tab_trie_device1,'.', label='Device 1', color='blue')
plt.plot(time_device2_seconds/5, tab_trie_device2,'.', label='Device 2', color='green')
plt.plot(time_device3_seconds/5, tab_trie_device3,'.', label='Device 3', color='red')
plt.plot(time_device4_seconds/5, tab_trie_device4,'.', label='Device 4', color='orange')
plt.plot(time_device5_seconds/5, tab_trie_device5,'.', label='Device 5', color='purple')

plt.ylabel('T°C')
plt.xlabel(frame) #'Time ()')
plt.title('Device temp vs Time')
...
# Créer un dictionnaire avec les données que tu souhaites enregistrer
data = {
    'Time_Device1': time_device1,
    'Time_Device2': time_device2,
    'Time_Device3': time_device3,
    'Time_Device4': time_device4,
    'Time_Device5': time_device5,
    'Time_Device1_Seconds': time_device1_seconds,
    'Time_Device2_Seconds': time_device2_seconds,
    'Time_Device3_Seconds': time_device3_seconds,
    'Time_Device4_Seconds': time_device4_seconds,
    'Time_Device5_Seconds': time_device5_seconds,
    'Tab_Trie_Device1': tab_trie_device1,
    'Tab_Trie_Device2': tab_trie_device2,
    'Tab_Trie_Device3': tab_trie_device3,
    'Tab_Trie_Device4': tab_trie_device4,
    'Tab_Trie_Device5': tab_trie_device5,
}
...
file_path = '/Volumes/Expansion/Reseau/ThermosensorsDatas/25_03_07_2_Thermosensors1_trie.csv'
